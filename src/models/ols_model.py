...
class OLSModel(BaseModel):
    ...
    def __init__(self, feature_columns=None, normalize=False):
        super().__init__("OLS", feature_columns)
    ...
    def train(self, X: pd.DataFrame, y: pd.Series) -> None:
        ...
        print(f"OLS model trained on {len(X_clean)} samples with {X_clean.shape[1]} features")
